 ...
 const footSocial = [
   {
     ...
     path: "https://www.facebook.com/yonodigitalofficial?mibextid=ZbWKwL",
   },
   {
     id: 2,
   ...
   },
   {
     ...
     path: "https://instagram.com/yonodigitalofficial?utm_source=qr&igshid=OGU0MmVlOWVjOQ==",
   },
   {
     id: 4,
            ...
            <div className="foot_about foot1">
              <div className="foot_logo">
                <Link to="/" style={{ textDecoration: "none" }}>
                  <img
                    src={require("../../../Image/yonologo.png")}
          ...
          <div className="container_Footer">
            <div className="sub_footer_wrapper">
              ...
              <div className="foot_copyright">
                <p>
                  &copy; {currYear} | Yono Digital, All Rights Reserved.
                  <span>
                    <a href="omranjan_official"> | Built by Omprakash Ranjan</a>
                  </span>
                </p>
              </div>
            </div>
