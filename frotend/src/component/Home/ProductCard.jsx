...
const useStyles = makeStyles((theme) => ({
  root: {
    width: "100%", // Set the card width to 100% by default
    maxWidth: "280px",
    height: FitScreen,
    ...
    currsor: "pointer",
     ...
     // Add responsive width using Media Queries
     [theme.breakpoints.down("sm")]: {
      maxWidth: "220px", // Adjust the width for small screens
    },
    [theme.breakpoints.down("xs")]: {
      maxWidth: "174px", // Adjust the width for extra small screens
    },
  },
  media: {
