    ...
    <div className="privacy-policy-container">
     <MetaData title={"Privacy Policy"} />
      <div className="container___">
        <h1>Privacy Policy of Yono Digital</h1>
        <p style={{ fontSize: "16px", fontWeight: "600" }}>
          {" "}
          Effective Date: 23-12-2021
        </p>
        <p>
          At Yono Digital, we value the privacy of our customers and are
        ...
        <p>
          By using the Yono Digital website and services, you agree to the
