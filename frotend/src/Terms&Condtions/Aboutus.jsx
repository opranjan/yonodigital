      ...
      <div className={classes.about_us}>
        ...
        <Container className={classes.container_12}>
          <Grid container spacing={4} justifyContent="center">
            ...
            <Grid item xs={12} sm={6}>
              ...
              Yono Digital store is an online Consumer electronic selling startup
                started in 2023. We have served more than 1000 customers
                through social media and other platforms. We are proud to offer
                our own products under the brand name YD, also known as "Yono Digital".
              </Typography>
              <Typography variant="body1" className={classes.introText_about}>
              Yono Digital was founded by Omprakash Ranjan, a talented Engineers and Entrepreneur
        ...
        <Container className={classes.container_12}>
          ...
          <Typography variant="body1" className={classes.infoText_about}>
            ...
            product range to meet the evolving needs of Customers. Our team of
